  ...
  return (
    <label className="block">
      ...
      <select
        value={value || ""}
        onChange={(e) => onChange(e.target.value)}
        className="mt-1.5 w-full rounded-lg border border-[#e5e7eb] px-3 py-2 text-sm outline-none transition-all focus:border-[#5A1A14] focus:ring-2 focus:ring-[#5A1A14]/20 bg-white"
      >
  ...
  return (
    ...
    >
      <div className="grid gap-4 sm:grid-cols-3">
        <div className="sm:col-span-3 flex items-center gap-4">
          <div className="flex h-20 w-20 shrink-0 items-center justify-center overflow-hidden rounded-xl border border-[#e5e7eb] bg-[#FFFFFF]">
            {form.logo ? (
              ...
              <Building2 size={28} className="text-[#5A1A14]" />
            )}
          </div>
          <div>
            <span className="text-xs font-semibold text-[#1A1A1A]">Profile picture</span>
            <div className="mt-1.5 flex items-center gap-2">
              <label className="inline-flex cursor-pointer items-center gap-1.5 rounded-lg bg-[#5A1A14] px-3 py-1.5 text-xs font-semibold text-white hover:bg-[#6B7280]">
          ...
          {primaryContact ? (
            <div className="mt-1.5 flex items-center justify-between gap-2 rounded-lg border border-[#e5e7eb] bg-[#FFFFFF] px-3 py-2 text-sm">
              ...
              <span className="flex shrink-0 items-center gap-1">
                <button type="button" onClick={() => setShowContactForm(true)} className="text-[#5A1A14] hover:text-[#5A1A14]" title="Edit contact">
                  <Pencil size={13} />
                </button>
            ...
            <button
              ...
              className="mt-1.5 flex w-full items-center gap-1.5 rounded-lg border border-dashed border-[#e5e7eb] px-3 py-2 text-sm font-semibold text-[#5A1A14] hover:bg-[#E5E7EB]"
            >
        ...
        <div className="sm:col-span-3 mt-1 border-t border-[#F0EDE4] pt-3">
        ...
        <label className="block sm:col-span-3">
          ...
          <textarea
            ...
            className="mt-1.5 min-h-24 w-full rounded-lg border border-[#e5e7eb] px-3 py-2 text-sm outline-none focus:border-[#5A1A14] focus:ring-2 focus:ring-[#5A1A14]/20 transition-all"
          />
        </label>
      </div>
