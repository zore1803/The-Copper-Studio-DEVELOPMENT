      ...
      <div className="space-y-4">
        ...
        <div className="rounded-lg border border-[#e5e7eb] bg-[#fafafa] p-3 space-y-3">
          ...
          <label className="block">
            ...
            <select
              ...
              className="mt-1.5 w-full rounded-lg border border-[#e5e7eb] bg-white px-3 py-2 text-sm outline-none focus:border-[#C55418] focus:ring-2 focus:ring-[#C55418]/20 disabled:bg-[#f3f4f6] disabled:text-[#9ca3af]"
            >
          ...
          <div className="mt-1.5 rounded-lg border border-dashed border-[#d8c2b9] bg-[#fff8f6] px-3 py-3">
            <div className="flex items-center gap-3">
              ...
              <label
                ...
                className={`rounded-lg bg-[#C55418] px-3 py-1.5 text-xs font-semibold text-white hover:bg-[#9A4113] ${reading || saving ? "pointer-events-none opacity-60" : "cursor-pointer"}`}
              >
                Browse…
              </label>
        ...
        <label className="block">
          ...
          <input
            ...
            disabled={fileReady}
            className="mt-1.5 w-full rounded-lg border border-[#e5e7eb] px-3 py-2 text-sm outline-none focus:border-[#C55418] focus:ring-2 focus:ring-[#C55418]/20 disabled:bg-[#f9fafb] disabled:text-[#9ca3af]"
          />
