          ...
          <div className="mt-1.5 rounded-lg border border-dashed border-[#d8c2b9] bg-[#fff8f6] px-3 py-3">
            <div className="flex items-center gap-3">
              ...
              <label
                ...
                className={`rounded-lg bg-[#8D3118] px-3 py-1.5 text-xs font-semibold text-white hover:bg-[#9A4113] ${reading || saving ? "pointer-events-none opacity-60" : "cursor-pointer"}`}
              >
                Browse…
              </label>
