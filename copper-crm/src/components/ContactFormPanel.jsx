  ...
  return (
    <label className={`flex items-center gap-2 rounded-lg border border-[#e5e7eb] px-3 py-2.5 text-sm font-medium text-[#374151] cursor-pointer hover:bg-[#f9fafb] ${span ? "sm:col-span-3" : ""}`}>
      <input
        ...
        className="h-4 w-4 rounded border-[#d1d5db] accent-[#C55418]"
      />
      {label}
    </label>
  );
  ...
  return (
    <div className="relative sm:col-span-3" ref={ref}>
      ...
      <button
        ...
        aria-expanded={open}
        className="mt-1.5 flex w-full items-center justify-between gap-3 rounded-lg border border-[#e5e7eb] bg-white px-3 py-2 text-left text-sm outline-none transition-colors hover:bg-[#f9fafb] focus:border-[#C55418] focus:ring-2 focus:ring-[#C55418]/20"
      >
