  ...
  return (
    <div className={`flex flex-col gap-1.5 ${className}`}>
      ...
      <input
        ...
        value={value}
        onChange={onChange}
        className="w-full px-3 py-2 text-sm border border-[#d8c2b9] rounded-xl outline-none focus:ring-2 focus:ring-[#ffdbcc] focus:border-[#8D3118] transition-all placeholder:text-[#b49f96]"
      />
    </div>
  );
}
...
export function Avatar({ name, size = "md" }) {
  ...
  const colors = ["#8D3118","#6E2412","#026769","#a66443","#665d50","#362f2c"];
