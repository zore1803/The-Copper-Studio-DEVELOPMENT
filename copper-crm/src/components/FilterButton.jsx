  ...
  return (
    <div className="relative">
      <button
        ...
        className={`relative flex items-center justify-center rounded-full border transition-colors ${open ? "border-[#C55418] bg-[#FFFFFF] text-[#C55418]" : "border-[#E5E7EB] bg-white text-[#1A1A1A] hover:bg-[#E5E7EB]"} ${buttonClassName || "h-9 w-9"}`}
      >
        <Filter size={16} />
        {activeCount > 0 && (
