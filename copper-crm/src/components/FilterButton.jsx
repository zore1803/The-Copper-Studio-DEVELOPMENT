  ...
  return (
    <div className="relative">
      <button
        ...
        className={`relative flex items-center justify-center rounded-full border transition-colors ${open ? "border-[#8D3118] bg-[#fff8f6] text-[#8D3118]" : "border-[#E1E4EA] bg-white text-[#1F2937] hover:bg-[#f9fafb]"} ${buttonClassName || "h-8 w-8"}`}
      >
        <Filter size={16} />
        {activeCount > 0 && (
