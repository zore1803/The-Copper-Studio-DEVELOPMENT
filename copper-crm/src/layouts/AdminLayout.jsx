          ...
          >
            ...
            {item.children.map((child) => (
              <button
                ...
                className={`flex w-full items-center gap-2.5 px-3 py-2 text-sm hover:bg-[#f9fafb] ${isLeafActive(child, location) ? "text-[#8D3118] font-semibold" : "text-[#374151]"}`}
              >
          ...
          <div className="flex items-center gap-4 flex-1 justify-end">
            ...
            <div ref={quickAddRef} className="relative">
              <button
                ...
                className="flex h-8 w-8 items-center justify-center rounded-full bg-[#8D3118] text-white shadow-[inset_0_0_0_1.8px_rgba(255,255,255,0.25)] hover:bg-[#b06a48] transition-colors"
              >
                <Plus size={16} />
              </button>
              {quickAddOpen && (
