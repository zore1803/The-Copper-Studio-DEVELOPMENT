        ...
        {view === "table" ? (
          <>
            <div className="overflow-hidden rounded-xl border border-[#E1E4EA] bg-white">
              <div className="grid grid-cols-[minmax(200px,1.2fr)_minmax(160px,1fr)_150px_minmax(160px,1fr)_120px_110px_auto] gap-4 border-b border-[#6E2412] bg-[#8D3118] px-4 py-3 text-xs font-bold uppercase tracking-wide text-white/90">
