          ...
          <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
              ...
              <div className="min-w-0">
                ...
                {roles.length > 0 && (
                  <div className="mt-3 flex flex-wrap gap-1.5">
                    {roles.map((role) => (
                      <span key={role} className="rounded-full bg-[#fff1ec] px-2 py-0.5 text-[11px] font-semibold text-[#8D3118]">{role}</span>
                    ))}
                  </div>
                )}
              </div>
            ...
            <div className="flex flex-wrap items-center justify-end gap-2.5">
              ...
              <button
                ...
                className={`inline-flex h-11 items-center gap-1.5 rounded-full border px-4 text-sm font-semibold transition-colors ${contact.userId ? "border-[#d8c2b9] bg-[#fff1ec] text-[#8D3118] hover:bg-[#ffe7da]" : "border-[#d8c2b9] bg-white text-[#211a17] hover:bg-[#fff1ec]"}`}
              >
        ...
        <div className="flex items-center gap-1 overflow-x-auto px-6">
          {TABS.map((tab) => (
            <button
              ...
              className={`flex items-center gap-1.5 whitespace-nowrap border-b-[3px] px-4 py-3 text-sm font-semibold transition-colors ${activeTab === tab ? "border-[#8D3118] text-[#8D3118]" : "border-transparent text-[#1D1E22] hover:text-[#8D3118]"}`}
            >
              {tab}
              {Boolean(tabCounts[tab]) && (
                <span
                  className={`grid h-5 min-w-[20px] place-items-center rounded-full px-1.5 text-[11px] font-bold ${
                    activeTab === tab ? "bg-[#8D3118] text-white" : "bg-[#e5e7eb] text-[#374151]"
                  }`}
                >
                  {tabCounts[tab]}
                </span>
