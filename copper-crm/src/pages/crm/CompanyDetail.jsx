        ...
        {projects.length ? (
          projects.map((project) => {
            ...
            return (
              <label
                key={id}
                className={`flex items-center justify-between rounded-full border px-3 py-2 text-sm cursor-pointer transition-colors ${checked ? "border-[#8D3118] bg-[#fff1ec]" : "border-[#e5e7eb] hover:bg-[#f9fafb]"}`}
              >
  ...
  return (
    <div className="flex h-8 items-center gap-2 rounded-full border border-[#E1E4EA] bg-white px-3">
      ...
      <input
        ...
        className="w-44 bg-transparent text-sm outline-none placeholder:text-[#525866]"
      />
    </div>
  );
}
    ...
    <div className="overflow-x-auto">
      <table className="min-w-full text-sm">
        <thead className="bg-[#8D3118] border-b border-[#6E2412]">
          <tr>
            <th className="py-3 pl-5 pr-4 text-left text-xs font-medium text-white/90">Project</th>
            <th className="py-3 pr-4 text-left text-xs font-medium text-white/90">Package</th>
            <th className="py-3 pr-4 text-left text-xs font-medium text-white/90">Status</th>
            <th className="py-3 pr-4 text-left text-xs font-medium text-white/90">Progress</th>
            <th className="py-3 pr-4 text-left text-xs font-medium text-white/90">Due</th>
            <th className="py-3 pr-4 text-left text-xs font-medium text-white/90">Project Manager</th>
            <th className="py-3 pr-4 text-right text-xs font-medium text-white/90">Budget</th>
          ...
          {projects.map((project) => (
            <tr key={project.id || project._id} onClick={() => onOpen(`/admin/companies/${companyId}/projects/${project.id || project._id}`)} className="cursor-pointer border-b border-[#f9fafb] hover:bg-[#fafafa]">
              ...
              <td className="py-3 pl-2 pr-5 text-right" onClick={(event) => event.stopPropagation()}>
                <button onClick={() => onDelete(project)} className="rounded-full p-2 text-[#9ca3af] hover:bg-red-50 hover:text-red-600" title="Delete project">
                  <Trash2 size={14} />
                </button>
              </td>
            </tr>
  ...
  return (
    <div className="overflow-x-auto">
      <table className="min-w-full text-sm">
        <thead className="bg-[#8D3118] border-b border-[#6E2412]">
          <tr>
            <th className="py-3 pl-5 pr-4 text-left text-xs font-medium text-white/90">Contact</th>
            <th className="py-3 pr-4 text-left text-xs font-medium text-white/90">Email</th>
            <th className="py-3 pr-4 text-left text-xs font-medium text-white/90">Phone</th>
            <th className="py-3 pr-4 text-left text-xs font-medium text-white/90">WhatsApp</th>
            <th className="py-3 pr-4 text-left text-xs font-medium text-white/90">LinkedIn</th>
            <th className="py-3 pr-4 text-left text-xs font-medium text-white/90">Status</th>
            <th className="py-3 pr-5 text-right text-xs font-medium text-white/90">Actions</th>
          </tr>
        </thead>
            ...
            <tr key={contact.id || contact._id}>
              ...
              <td className="py-3 pr-5 text-right">
                <div className="inline-flex items-center gap-2">
                  <button onClick={() => onView(contact)} className="rounded-full p-2 text-[#6b7280] hover:bg-[#f3f4f6] hover:text-[#8D3118]"><Eye size={14} /></button>
                  <button onClick={() => onEdit(contact)} className="rounded-full p-2 text-[#6b7280] hover:bg-[#f3f4f6] hover:text-[#8D3118]"><Edit2 size={14} /></button>
                  <button onClick={() => onPrimary(contact)} className="rounded-full p-2 text-[#6b7280] hover:bg-emerald-50 hover:text-emerald-700"><CheckCircle2 size={14} /></button>
                  <button onClick={() => onDelete(contact)} className="rounded-full p-2 text-[#6b7280] hover:bg-red-50 hover:text-red-600"><Trash2 size={14} /></button>
                </div>
              </td>
            </tr>
          );})}
  ...
  return (
    <div className="overflow-x-auto">
      <table className="min-w-full text-sm">
        <thead className="bg-[#8D3118] border-b border-[#6E2412]">
          <tr>
            <th className="py-3 pl-5 pr-4 text-left text-xs font-medium text-white/90">Invoice ID</th>
            <th className="py-3 pr-4 text-left text-xs font-medium text-white/90">Amount</th>
            <th className="py-3 pr-4 text-left text-xs font-medium text-white/90">Date</th>
            <th className="py-3 pr-4 text-left text-xs font-medium text-white/90">Due Date</th>
            <th className="py-3 pr-4 text-left text-xs font-medium text-white/90">Status</th>
            <th className="py-3 pr-4 text-left text-xs font-medium text-white/90">Payment</th>
            <th className="py-3 pr-4 text-left text-xs font-medium text-white/90">Transaction ID</th>
            <th className="py-3 pr-5 text-right text-xs font-medium text-white/90">Actions</th>
          </tr>
        </thead>
        <tbody className="divide-y divide-[#f3f4f6] bg-white">
          {invoices.map((invoice) => (
            <tr key={invoice.id || invoice._id}>
              ...
              <td className="py-3 pr-5 text-right">
                <div className="inline-flex items-center gap-2">
                  <button onClick={() => onView(invoice)} className="rounded-full p-2 text-[#6b7280] hover:bg-[#f3f4f6] hover:text-[#8D3118]"><Eye size={14} /></button>
                  <button onClick={() => onDownload(invoice)} className="rounded-full p-2 text-[#6b7280] hover:bg-[#f3f4f6] hover:text-[#8D3118]"><Download size={14} /></button>
                </div>
              </td>
            </tr>
          ))}
            ...
            return (
              ...
              >
                <button
                  ...
                  className="absolute right-2 top-2 rounded-full p-1.5 text-[#9ca3af] hover:bg-red-50 hover:text-red-600"
                  title="Delete group"
                >
                  <Trash2 size={13} />
                </button>
        ...
        return (
          <div key={doc.id || doc._id || name} className="flex items-center justify-between gap-3 rounded-xl border border-[#e5e7eb] bg-white p-3">
            ...
            <div className="flex shrink-0 items-center gap-2">
              {canOpen ? (
                <a href={doc.fileUrl} target="_blank" rel="noreferrer" className="rounded-lg bg-[#8D3118] px-3 py-1.5 text-xs font-semibold text-white hover:bg-[#9A4113]">
                  View
                </a>
              ) : (
              ...
              {onDelete ? (
                <button onClick={() => onDelete(doc)} className="rounded-full p-2 text-[#6b7280] hover:bg-red-50 hover:text-red-600" title="Delete document">
                  <Trash2 size={14} />
                </button>
              ) : null}
            </div>
                            ...
                            <div className={snap.isDragging ? "kanban-card-lift" : ""}>
                              <div className="flex items-start justify-between gap-2">
                                ...
                                <button
                                  ...
                                  className="shrink-0 rounded-full p-1 text-[#9ca3af] hover:bg-red-50 hover:text-red-600"
                                  title="Delete task"
                                >
                                  <Trash2 size={13} />
                                </button>
  ...
  return (
    <div className="overflow-x-auto">
      <table className="min-w-full text-sm">
        <thead className="bg-[#8D3118] border-b border-[#6E2412]">
          <tr>
            <th className="py-3 pr-4 text-left text-xs font-medium text-white/90">Task</th>
            <th className="py-3 pr-4 text-left text-xs font-medium text-white/90">Assigned To</th>
            <th className="py-3 pr-4 text-left text-xs font-medium text-white/90">Priority</th>
            <th className="py-3 pr-4 text-left text-xs font-medium text-white/90">Status</th>
            <th className="py-3 pr-4 text-left text-xs font-medium text-white/90">Due Date</th>
            <th className="py-3 pr-4 text-left text-xs font-medium text-white/90">Project</th>
            ...
            >
              <div className="flex items-start justify-between gap-2">
                ...
                <div className="flex shrink-0 items-center gap-1">
                  ...
                  <button type="button" onClick={() => onDelete(note)} className="rounded-full p-1.5 text-[#9ca3af] hover:bg-red-50 hover:text-red-600" title="Delete note">
                    <Trash2 size={14} />
                  </button>
                </div>
              </div>
