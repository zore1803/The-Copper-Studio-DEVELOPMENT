  ...
  return (
    <button
      ...
      className={`flex flex-col items-start gap-3 rounded-xl border p-4 text-left transition-colors ${
        active ? "border-[#B25A34] bg-[#fff8f6]" : "border-[#E1E4EA] bg-white hover:bg-[#fafafa]"
      }`}
    >
      <div className={`flex h-10 w-10 items-center justify-center rounded-lg border ${active ? "border-[#B25A34] text-[#B25A34]" : "border-[#E1E4EA] text-[#525866]"}`}>
        <FolderIcon size={18} />
      </div>
      <div>
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <button
          onClick={onAdd}
          className="flex h-[42px] items-center gap-1.5 self-start rounded-full bg-[#B25A34] px-3.5 text-xs font-medium text-white transition-colors hover:bg-[#B25A34] sm:self-auto"
        >
          <Plus size={15} />
          Add companies
        </button>
      ...
      {companies.length === 0 ? (
        <div className="rounded-xl border border-dashed border-[#E1E4EA] bg-white py-12 text-center">
          ...
          <button
            onClick={onAdd}
            className="mt-3 inline-flex items-center gap-1.5 rounded-full border border-[#B25A34] px-3.5 py-2 text-xs font-medium text-[#B25A34] transition-colors hover:bg-[#fff8f6]"
          >
          ...
          return (
            <label
              ...
              className={`flex cursor-pointer items-center gap-3 rounded-lg border px-3 py-2.5 transition-colors ${
                checked ? "border-[#B25A34] bg-[#fff8f6]" : "border-[#e5e7eb] hover:bg-[#f9fafb]"
              }`}
            >
              <input
                type="checkbox"
                checked={checked}
                onChange={() => toggle(id)}
                className="rounded border-[#d1d5db] accent-[#8D3118]"
              />
              <div className="min-w-0">
                <p className="truncate text-sm font-semibold text-[#111827]">{c.name}</p>
            ...
            <div className="flex flex-col gap-4 rounded-lg border border-[#E1E4EA] bg-white p-6 shadow-[0_4px_4px_rgba(0,0,0,0.05)] sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="flex h-[42px] items-center gap-1.5 whitespace-nowrap rounded-full bg-[#B25A34] px-3.5 text-xs font-medium text-white hover:bg-[#B25A34] transition-colors"
                >
                  <FolderPlus size={15} />
                  New Folder
                </button>
                  ...
                  <div className="flex items-center gap-1.5">
                    <div className="inline-flex h-9 items-center rounded-full border border-[#EAECF0] bg-white p-1">
                      <button
                        ...
                        className={`flex h-7 w-7 items-center justify-center rounded-full transition-colors ${
                          folderView === "list" ? "bg-[#B25A34] text-white" : "text-[#525866] hover:bg-[#f9fafb]"
                        }`}
                      >
                        <List size={15} />
                      </button>
                      <button
                        ...
                        title="Icon view"
                        className={`flex h-7 w-7 items-center justify-center rounded-full transition-colors ${
                          folderView === "grid" ? "bg-[#B25A34] text-white" : "text-[#525866] hover:bg-[#f9fafb]"
                        }`}
                      >
                        <Grid2x2 size={15} />
                      </button>
                    ...
                    {Array.from({ length: folderTotalPages }, (_, i) => i + 1).slice(0, 5).map((p) => (
                      <button
                        ...
                        className={`flex h-8 w-8 items-center justify-center rounded-lg text-sm font-semibold transition-colors ${
                          p === folderPage ? "bg-[#B25A34] text-white" : "border border-[#EAECF0] text-[#525866] hover:bg-[#f9fafb]"
                        }`}
                      >
                        {p}
                      </button>
