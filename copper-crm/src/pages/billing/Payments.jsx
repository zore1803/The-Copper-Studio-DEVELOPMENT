        ...
        <div className="flex items-center justify-between gap-2 min-w-0">
          <div className="flex items-center gap-2 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <p className="hidden text-xs text-[#525866] mt-0.5 sm:block">Actual money received, Razorpay mapping, refund state, and payment audit.</p>
            </div>
          </div>
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full">
                <thead className="bg-[#8D3118] border-b border-[#6E2412]">
                  <tr>
                    <th className="px-4 py-3 text-left text-xs font-bold text-white">Payment Date</th>
                    <th className="px-4 py-3 text-left text-xs font-bold text-white">Payment ID</th>
                    <th className="px-4 py-3 text-left text-xs font-bold text-white">Company</th>
                    <th className="px-4 py-3 text-left text-xs font-bold text-white">Contact</th>
