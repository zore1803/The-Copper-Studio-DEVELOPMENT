      ...
      <div style={{ width: "min(1100px, calc(100% - 40px))", margin: "0 auto", paddingBottom: 80 }}>
            ...
            return (
              <div
                ...
                style={{
                  ...
                  gap: 14,
                  padding: "28px 26px",
                  border: featured ? "1px solid #8D3118" : "1px solid #E5E7EB",
                  borderRadius: 14,
                  background: "#ffffff",
                  boxShadow: featured
              ...
              >
                ...
                <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 12 }}>
                  ...
                  {featured && (
                    <span style={{ flexShrink: 0, background: "#FFFFFF", color: "#8D3118", fontSize: "0.68rem", fontWeight: 800, letterSpacing: "0.06em", textTransform: "uppercase", padding: "4px 10px", borderRadius: 999 }}>
                      Popular
                    </span>
                  )}
                </div>
        ...
        <div style={{
          ...
          <a
            ...
            onMouseEnter={(e) => { e.currentTarget.style.background = "#8D3118"; }}
