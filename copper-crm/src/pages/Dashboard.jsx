...
const TONE_STYLES = {
  brown: { tint: "bg-[#FFFFFF]", text: "text-[#C55418]", bar: "bg-[#C55418]" },
  slate: { tint: "bg-[#FFFFFF]", text: "text-[#C55418]", bar: "bg-[#C55418]" },
  ...
  return (
    <div className="bg-white rounded-xl border border-[#e5e7eb] shadow-[0_1px_3px_rgba(0,0,0,0.04)]">
      <div className="px-6 py-4 border-b border-[#FFFFFF] flex items-center justify-between">
        ...
        <span className="rounded-full bg-[#FFFFFF] px-3 py-1 text-xs font-bold text-[#C55418]">{formatCompact(totalVal)}</span>
      </div>
        ...
        {quarters.map(q => (
          <button
            ...
            className={`flex-1 py-1 text-xs font-semibold rounded-lg border transition-colors ${
              q === quarter ? "bg-[#C55418] text-white border-[#C55418]" : "border-[#e5e7eb] text-[#6b7280] hover:bg-[#E5E7EB]"
            }`}
          >
            {q}
          </button>
          ...
          {TABS.map((t) => (
            <button
              ...
              className={`px-4 py-3.5 text-sm font-semibold border-b-2 transition-colors ${
                tab === t ? "border-[#C55418] text-[#C55418]" : "border-transparent text-[#6b7280] hover:text-[#1A1A1A]"
              }`}
            >
              {t}
            </button>
