        ...
        {uploadProgress !== null && (
          <div className="mt-3">
            ...
            <div className="h-2 w-full overflow-hidden rounded-full bg-[#f1e6e0]">
              <div
                className="h-full rounded-full bg-[#884c2d] transition-[width] duration-200 ease-out"
        ...
        <div className="mb-5 flex flex-wrap items-center justify-between gap-3">
          {activeFolder ? (
            <nav className="flex items-center gap-1.5 text-base">
              <button
                ...
                className="font-display font-semibold text-[#884c2d] hover:underline"
              >
                Directory
              </button>
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <select
              ...
              className="h-9 rounded-lg border border-[#e5e7eb] bg-white px-2 text-xs text-[#374151] outline-none focus:border-[#884c2d]"
            >
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div className="min-w-0">
                            <button
                              type="button"
                              onClick={() => openDocument(doc, (msg) => showToast({ type: "error", title: "Can't open", message: msg }))}
                              className="block max-w-[220px] truncate text-left text-sm font-semibold text-[#211a17] hover:text-[#884c2d] hover:underline"
                            >
                              {doc.name}
                            </button>
