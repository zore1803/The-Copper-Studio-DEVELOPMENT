    ...
    <div className="flex min-h-full flex-col bg-[#FFFFFF]" onClick={() => setDocMenu(null)}>
      ...
      <div className="rounded-xl border border-[#e5e7eb] bg-white px-4 py-3">
        <div className="flex flex-wrap items-center gap-3">
          <FilePlus2 size={15} className="text-[#5A1A14] shrink-0" />
          ...
          <select
            ...
            className="text-xs border border-[#e5e7eb] rounded-lg px-2 py-1 outline-none focus:border-[#5A1A14]"
          >
          ...
          <button
            ...
            className="ml-auto flex items-center gap-1.5 rounded-lg bg-[#5A1A14] px-3 py-1.5 text-xs font-semibold text-white hover:bg-[#6B7280] transition-colors disabled:cursor-not-allowed disabled:opacity-40"
          >
        ...
        {uploadProgress !== null && (
          <div className="mt-3">
            ...
            <div className="h-2 w-full overflow-hidden rounded-full bg-[#E5E7EB]">
              <div
                className="h-full rounded-full bg-[#5A1A14] transition-[width] duration-200 ease-out"
      ...
      <section>
          ...
          {newFolderMode ? (
            <form onSubmit={handleAddFolder} className="flex items-center gap-2">
              <input
                ...
                className="rounded-lg border border-[#e5e7eb] px-3 py-1.5 text-xs outline-none focus:border-[#5A1A14] w-36"
              />
              <button type="submit" className="grid h-7 w-7 place-items-center rounded-lg bg-[#5A1A14] text-white hover:bg-[#6B7280]">
                <Check size={13} />
              </button>
        ...
        {folders.length ? (
          ...
          <div className="rounded-xl border border-dashed border-[#6B7280] bg-[#FFFFFF] p-8 text-center">
            ...
            <button onClick={() => setNewFolderMode(true)} className="mt-2 text-xs font-bold text-[#5A1A14] hover:underline">
        ...
        <div className="mb-5 flex flex-wrap items-center justify-between gap-3">
          {activeFolder ? (
            <nav className="flex items-center gap-1.5 text-base">
              <button
                ...
                className="font-display font-semibold text-[#5A1A14] hover:underline"
              >
                Directory
              </button>
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <select
              ...
              className="h-9 rounded-lg border border-[#e5e7eb] bg-white px-2 text-xs text-[#1A1A1A] outline-none focus:border-[#5A1A14]"
            >
                    ...
                    <tr key={menuKey || index} className="transition-colors hover:bg-[#E5E7EB]/60">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div className="min-w-0">
                            <button
                              type="button"
                              onClick={() => openDocument(doc, (msg) => showToast({ type: "error", title: "Can't open", message: msg }))}
                              className="block max-w-[220px] truncate text-left text-sm font-semibold text-[#1A1A1A] hover:text-[#5A1A14] hover:underline"
                            >
                              {doc.name}
                            </button>
                      ...
                      <td className="px-6 py-5 text-right relative" onClick={(e) => e.stopPropagation()}>
                        <button
                          ...
                          className="text-[#6b7280] transition-colors hover:text-[#5A1A14]"
                        >
