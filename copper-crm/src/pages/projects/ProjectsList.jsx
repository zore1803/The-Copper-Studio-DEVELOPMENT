            ...
            {statusFilters.map((item) => (
              <button
                ...
                className={`rounded-lg px-3 py-1.5 text-xs font-semibold transition-colors whitespace-nowrap ${
                  statusFilter === item.value ? "bg-[#5A1A14] text-white" : "bg-[#FFFFFF] text-[#6b7280] hover:bg-[#e5e7eb]"
                }`}
              >
                {item.label}
              </button>
              ...
              <tr>
                <td colSpan={9} className="px-5 py-10 text-center">
                  <div className="mx-auto flex justify-center items-center">
                    <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-[#5A1A14]"></div>
                  </div>
                ...
                <tr key={project.id || project._id} className="hover:bg-[#E5E7EB] transition-colors">
                  <td className="px-5 py-4">
                    <Link
                      ...
                      className="font-bold text-[#5A1A14] hover:underline"
                    >
                      {project.name}
                    </Link>
                  </td>
                  ...
                  <td className="px-5 py-4">
                    <div className="flex items-center gap-2">
                      <div className="h-2 w-16 overflow-hidden rounded-full bg-[#FFFFFF]">
                        <div
                          className={`h-full rounded-full ${project.computedProgress === 100 ? "bg-emerald-500" : "bg-[#5A1A14]"}`}
