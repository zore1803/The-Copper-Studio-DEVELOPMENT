  ...
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <input
        ...
        className={`h-8 w-full rounded-lg border bg-white px-3 text-sm text-[#111827] outline-none transition-all focus:ring-2 disabled:cursor-not-allowed disabled:bg-[#f9fafb] disabled:text-[#9ca3af] ${
                ...
                <div key={pkg.id} className="rounded-xl border border-[#f0e6e0] bg-[#fdfaf9] p-5">
                  ...
                  <div className="grid gap-4 sm:grid-cols-2">
                    <div>
                      ...
                      <input
                        className="h-8 w-full rounded-lg border border-[#e5e7eb] bg-white px-3 text-sm text-[#111827] focus:border-[#8D3118] focus:outline-none focus:ring-2 focus:ring-[#8D3118]/20"
                        value={e.label ?? ""}
