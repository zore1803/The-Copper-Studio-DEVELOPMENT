                  ...
                  {(data.packageRevenue.length ? data.packageRevenue : [{ name: "No packages yet", revenue: 0, count: 0 }]).map((item) => (
                    ...
                    >
                      <div className="flex items-center justify-between">
                        ...
                        <p className={`text-xs font-bold ${item.count > 0 ? "text-[#C55418] underline decoration-[#C55418]/30 underline-offset-2" : "text-[#9CA3AF]"}`}>
        ...
        <div className="flex items-center gap-2">
          <div className="relative">
            ...
            <input 
              ...
              className="pl-8 pr-4 py-1.5 text-sm border border-[#E1E4EA] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#C55418]/20 focus:border-[#C55418] w-full sm:w-64 transition-all"
            />
          </div>
        </div>
      </div>
